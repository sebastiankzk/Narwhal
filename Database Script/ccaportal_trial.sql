...
CREATE TABLE `trial` (
  ...
  `trialTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`trialID`),
  KEY `userID_idx` (`userID`),
  KEY `ccaID_idx` (`ccaID`),
  CONSTRAINT `ccaID` FOREIGN KEY (`ccaID`) REFERENCES `cca` (`ccaID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
