...
<html lang="en">
  ...
  <head>
    ...
    <title>NYP CCA Portal - Update Idemnity Status</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Update Indemnity Form Status
        <!--<small>(<?php echo $data->name; ?>)</small>-->
      </h1>
      <br/>

    <form method="post" action="<?php echo base_url('index.php/indemnity/update_indemnity/'.$query->indemnityID); ?>">
      <div class="row">
        ...
        <div class="row col-lg-6">
          <input type="text" name="name" class="form-control" required=""disabled value="<?php echo $query->username; ?>"</div>
        </div>
      </div>
      <br/>
      ...
      <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-2">
          <label for="venue">CCA:</label>
        </div>
        <div class="row col-lg-6">
          <input type="text" name="cca" class="form-control" required="" disabled value="<?php echo $query->ccaname; ?>"</div>
        </div>
      </div>
      <br/>
      ...
      <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-2">
          <label for="venue">Name of Parent:</label>
        </div>
        <div class="row col-lg-6">
          <input type="text" name="cca" class="form-control" required="" disabled value="<?php echo $query->nameOfParent; ?>"</div>
        </div>
      </div>
      <br/>
      ...
      <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-2">
          <label for="venue">Emergency Contact:</label>
        </div>
        <div class="row col-lg-6">
          <input type="text" name="cca" class="form-control" required="" disabled value="<?php echo $query->emergencyContact; ?>"</div>
        </div>
      </div>
      <br/>
      ...
      <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-2">
          <label for="venue">Medical Record:</label>
        </div>
        <div class="row col-lg-6">
          <input type="text" name="cca" class="form-control" required="" disabled value="<?php echo $query->medicalRecord; ?>"</div>
        </div>
      </div>
      <br/>
      ...
      <div class="row">
        ...
        <a href="<?php echo base_url('index.php/indemnity'); ?>">
