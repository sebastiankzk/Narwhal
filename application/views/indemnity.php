...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Indemnity Form
      </h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-sm-12">
            ...
            <tbody>
              <?php $index = 1; foreach ($indemnitylist as $row):?>
              <tr>
                <td><?=$index++?></td>
                <td><?=$row->username?></td>
                <td><?=$row->ccaname?></td>
                ...
                <?php if($this->session->userdata('role') == 'Leader') : ?>
                <form method="post" action="indemnity/get_indemnity">
                <input type="hidden" id="indemnityID" name="indemnityID" value='<?=$row->indemnityID?>' />
