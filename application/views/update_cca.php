  ...
  <div class="container">
    ...
    <form method="post" action="<?php echo base_url('index.php/admin/update_cca/'.$query->ccaID); ?>" enctype='multipart/form-data'>
      ...
      <div class="row">
        ...
        <div class="row col-lg-6">
          <input type="text" name="category" class="form-control" placeholder="Category" required="" value="<?php echo $query->category; ?>"</div>
        </div>
      </div>
      <br/>
      <div class="row">
        ...
        <div class="row col-lg-6">
          <textarea name="information" class="form-control" required="" rows="10"><?php echo $query->information; ?></textarea>
        </div>
      </div>
      <br/>
      <div class="row">
