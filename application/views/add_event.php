...
<html lang="en">
  ...
  <head>
    ...
    <title>NYP CCA Portal - Add new Event</title>
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <li class="nav-item dropdown">
        ...
        <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('index.php/leader'); ?>">Leader</a>
        </li>
        <?php endif; ?>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Add new Event
      </h1>
      <br/>
      
    <form method="post" action="<?php echo base_url('index.php/event/add_specific_event/'); ?>">
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="row col-lg-6">
          <input type="date" name="date" class="form-control" required="" value=""</div>
        </div>
      </div>
      <br/>
      ...
      <div class="row">
        ...
        <div class="row col-lg-6">
          <input type="time" name="time" class="form-control" placeholder="Training Time" required="" value=""</div>
        </div>
      </div>
      <br/>  
      <div class="row">
